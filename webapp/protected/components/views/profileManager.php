	...
	if(!$(this).hasClass('disabled'))
	{
		...
		//	alert(data);
			...
			$.post("<?php echo Yii::app()->baseUrl;?>/index.php/user/changeProfile",data,function(result){
				...
				<?php } ?>
				//更改按钮
				$('#<?php echo $id;?> > div.head > div.right > div.floatButton > div.btn').html("编辑")
...
<div id='<?php echo $id;?>'>
	...
	<div class="modal hide fade" id="<?php echo $id;?>editPwModal" style="width:500px;margin-left:-250px"><!--to set the modal in the center,margin-left should be (-)half its width-->
		...
		<div class='modal-body'>
			<div class='line'>
				<div class='left'>Original Password</div><div class='right'><input class='input-medium' type='password' id='oldPw'></input></div>
			</div>
			<div class='line'>
	...
	<div class='profileDiv'>
		...
		<?php if($hasEditComp){ ?>
		<div class='line'>
			<div class='left'>Username</div><div class='right'><?php echo $userName;?> &nbsp;&nbsp;<a href='#' data-toggle="modal" data-target="#<?php echo $id;?>editPwModal" class='editPw'>修改密码</a></div>
		</div>
		<?php } ?>
		<?php if($showNickName){ ?>
		<div class='line'>
			<div class='left'>Nick Name</div><div class='right nickName'><?php echo $userNickName;?></div>
		</div>
		<?php } ?>
		<?php if($showIntro){ ?>
		<div class='line'>
		...
		<?php if($isCompetitor){ ?>
			...
			"param" => array(
				array(
					...
					"title" => "真实姓名",
					"type" => "text",
					"text" => $specific['realName'],
				),
				array(
					"name" => "school",
					"title" => "参赛学校",
					"type" => "text",
					"text" => $specific['school'],
				),
				array(
					"name" => "schoolType",
					"title" => "选手类别",
					"type" => "text",
					"text" => $specific['schoolType'],
				),
				array(
					"name" => "location",
					"title" => "学校位置",
					"type" => "text",
					"text" => $specific['locationName'],
				),
				array(
					"name" => "catalog",
					"title" => "参加赛区",
					"type" => "text",
					"text" => $specific['catalogTitle'],
				),
				array(
					"name" => "email",
					"title" => "电子邮件",
				...
				array(
					...
					"title" => "电话",
					"type" => "text",
					"text" => $specific['phoneNum'],
				),
				array(
					"name" => "cellphoneNum",
					"title" => "手机",
					"type" => "text",
					"text" => $specific['cellphoneNum'],
				),
			),
			));
		 ?>
